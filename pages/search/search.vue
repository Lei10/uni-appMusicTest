		...
		<view class="container" v-show="true">
			<scroll-view scroll-y="true">
				<view class="search-search">
					...
					<input type="text" placeholder="搜索歌曲" @confirm="handleToSearch(searchWord)" v-model="searchWord" @input="handleToSuggest"/>
				...
				<block v-if=" searchType == 1">
					...
					<view class="search-history">
						<view class="search-history-head">
							<text>历史记录</text>
							<text class="iconfont iconlajitong" @tap="hanleToClear"></text>
						</view>
...
<!-- 						<view class="search-result-item">
						...
						<view @tap="handleToDetail(item.id)" class="search-result-item" v-for = "(item,index) in searchList" :key = "index">
							<view class="search-result-word">
								<view>{{ item.name }}</view>
...
<!-- 						<view class="search-suggest-item">
						...
						<view @tap="handleToWord(item.keyword)" class="search-suggest-item" v-for="(item,index) in searchSuggest" :key = "index">
